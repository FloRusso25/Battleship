...
function addSalvoListener(){
    document.querySelectorAll('[id^="salvos"][class="grid-cell"]').forEach(i=>i.addEventListener("click", function(){i.classList.toggle("clickSelected")}));
}

createGrid(11, document.getElementById('grid'), 'ships');
createGrid(11, document.getElementById('gridSalvos'), 'salvos');
